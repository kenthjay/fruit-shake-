                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Shop</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="all_restaurant.php">Add Shop</a></li>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
    <?php 
        echo $rows['payment_method'] === 'COD' ? 'Cash on Delivery' : 
             ($rows['payment_method'] === 'pickup' ? 'Pick Up' : 'N/A');
    ?>
</td>
                                                ...
                                                <td>
                                                    <form method="POST" action="update_order_status.php">
                                                        <input type="hidden" name="order_id" value="<?php echo $rows['o_id']; ?>">
                                                        <select name="status" onchange="this.form.submit()">
                                                            <option value="ORDER IS BEING PREPARED" <?php echo ($rows['status'] == "ORDER IS BEING PREPARED") ? 'selected' : ''; ?>>ORDER IS BEING PREPARED</option>
                                                            <option value="ORDER IS ON THE WAY" <?php echo ($rows['status'] == "ORDER IS ON THE WAY") ? 'selected' : ''; ?>>ORDER IS ON THE WAY</option>
                                                            <option value="ORDER RECIEVED" <?php echo ($rows['status'] == "ORDER RECIEVED") ? 'selected' : ''; ?>>ORDER RECIEVED</option>
                                                            <option value="ORDER CANCEL" <?php echo ($rows['status'] == "ORDER CANCEL") ? 'selected' : ''; ?>>ORDER CANCEL</option>
                                                        </select>
                                                    </form>
                                                </td>
