...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/FRUITS.jpg">
            ...
            <h1>Order Delivery & Take-Out </h1>
                ...
                <div class="steps">
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order Shakes</h4>
                    </div>
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="shakes.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">'.$r['price'].'</span>
                                                     <button 
    class="btn theme-btn-dash pull-right open-modal" 
    data-dish-id="'.$r['d_id'].'" 
    data-dish-name="'.$r['title'].'"
>Order Now</button>
 </div>
                                                </div>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Shop</h3>
                                <p>We"ve got your covered with menus from our Online Fruitshake Ordering System.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Order Shakes</h3>
                            <p>We"ve got your covered with a variety of Shakes online with our Online Fruitshake Ordering System </p>
                        </div>
                    </div>
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="shakes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="shakes.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																</div>
...
<div class="modal fade" id="sizeModal" tabindex="-1" role="dialog" aria-labelledby="sizeModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="orderForm" method="POST" action="product-action.php?action=add">


      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="sizeModalLabel">Choose Size & Quantity</h5>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">

          <!-- Dish ID (hidden) -->
          <input type="hidden" name="dish_id" id="modal_dish_id">

          <!-- Size options go here via JS -->
          <div id="sizeOptions"></div>

          <!-- Quantity -->
          <div class="form-group mt-3">
            <label for="quantity">Quantity:</label>
            <input type="number" name="quantity" id="modal_quantity" class="form-control" value="1" min="1" required>
    ...
    <!-- Add these just above </div> inside .modal-body -->
<input type="hidden" name="dish_id" id="modal_dish_id">
<input type="hidden" name="size" id="modal_selected_size">
<input type="hidden" name="price" id="modal_selected_price"> <!-- Optional -->
...
$('.open-modal').on('click', function () {
    ...
    $('#sizeModalLabel').text("Select Size for " + dishName);
    ...
    $.ajax({
        ...
        success: function (response) {
            $('#sizeOptions').html(response);
            $('#sizeModal').modal('show');
        }
    });
});

// Handle radio selection from AJAX-loaded size options
$(document).on('change', 'input[name="size_option"]', function () {
    const value = $(this).val(); // example: "medium|80"
    const parts = value.split('|');
    const size = parts[0];
    const price = parts[1];

    $('#modal_selected_size').val(size);
    $('#modal_selected_price').val(price); // optional
});
