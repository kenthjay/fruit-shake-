...
<head>
    <meta charset="UTF-8">
    <title>Login || Fruitshake Ordering System</title>
...
<body>
    ...
    <div style="background-image: url('images/Homepic.jpg'); background-repeat: no-repeat; background-size: cover;  background-position: center;">
